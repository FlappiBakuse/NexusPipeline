...
<template>
  <component
    ...
    data-entity-row
  >
    <div v-if="hasSlot('leading')" class="nxp-entity-row-leading"><slot name="leading" /></div>
    ...
    <div v-if="hasSlot('actions')" class="nxp-entity-row-actions"><slot name="actions" /></div>
  </component>
</template>
