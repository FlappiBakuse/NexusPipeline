...
const props = withDefaults(defineProps<{ modelValue?: string; placeholder?: string; disabled?: boolean; type?: string }>(), { modelValue: "", placeholder: "", disabled: false, type: "text" });
