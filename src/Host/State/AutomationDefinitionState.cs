...
/// </summary>
internal class AutomationDefinitionState
{
    ...
    public void Mutate(Action<AutomationDefinitionMutationContext> mutation)
    {
        ArgumentNullException.ThrowIfNull(mutation);
        lock (_sync)
        {
            mutation(new AutomationDefinitionMutationContext(_scripts, _queues, _users));
        }
    }

    public TResult Mutate<TResult>(Func<AutomationDefinitionMutationContext, TResult> mutation)
    {
        ArgumentNullException.ThrowIfNull(mutation);
        lock (_sync)
        {
            return mutation(new AutomationDefinitionMutationContext(_scripts, _queues, _users));
        }
    }
...
internal sealed class AutomationDefinitionMutationContext
{
    internal AutomationDefinitionMutationContext(
