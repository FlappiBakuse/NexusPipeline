namespace NexusPipeline.Platform.Testing;

/// <summary>
/// 测试时间加速钩子：仅当环境变量 NEXUS_TIME_SCALE 设置（1-1000）时生效，生产不设置 = 行为零变化。
...
internal static class TestHooks
{
    ...
    /// <summary>测试用 adb 可执行文件路径（，env NEXUS_ADB_EXE）：e2e 用 stub adb 模拟模拟器命令，生产不设置。</summary>
