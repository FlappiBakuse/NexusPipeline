...
{
    private readonly McpToolContext _toolContext;

    private WebApplication? _app;

    public McpHost(McpToolContext toolContext)
    {
    ...
    private WebApplication BuildApp()
    {
        ...
        builder.Services.AddSingleton(_toolContext);
        ...
        IMcpServerBuilder mcp = builder.Services.AddMcpServer(options =>
        {
            ...
            {
                Name = "NexusPipeline",
                Version = _toolContext.HostVersion.CurrentVersion,
            };
