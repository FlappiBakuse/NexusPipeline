...
internal static class ExtraConfigStoreTransaction
{
    ...
    {
        string directory = ConfigPaths.ExtraStoreTransactionDir(scriptId, userKey, sitePath);
    ...
    {
        string root = Path.Combine(ConfigPaths.WorkDir(scriptId, userKey), "extra-store-txn");
    ...
    internal static void RecoverAll(string scriptId, string userKey)
    {
        ...
        foreach (string entry in Directory.GetFileSystemEntries(root))
        {
            ...
            string expectedDirectory = ConfigPaths.ExtraStoreTransactionDir(scriptId, userKey, manifest.SitePath);
        ...
        Action<string, string>? writeAtomic = null)
    {
        ...
        string transactionDir = ConfigPaths.ExtraStoreTransactionDir(scriptId, userKey, sitePath);
        ...
        string stage = ConfigPaths.ExtraStoreTransactionStageDir(scriptId, userKey, sitePath);
        string backup = ConfigPaths.ExtraStoreTransactionBackupDir(scriptId, userKey, sitePath);
        string manifestPath = ConfigPaths.ExtraStoreTransactionManifestPath(scriptId, userKey, sitePath);
        string commitPath = ConfigPaths.ExtraStoreTransactionCommitPath(scriptId, userKey, sitePath);
    ...
    private static void ValidateManifest(Manifest manifest, string scriptId, string userKey, string sitePath)
    {
        ...
        string expectedStore = Path.GetFullPath(ConfigPaths.StoreExtraDir(scriptId, userKey, sitePath));
