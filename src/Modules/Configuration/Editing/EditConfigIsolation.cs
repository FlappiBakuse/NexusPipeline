...
internal static class EditConfigIsolation
{
        ...
        bool copySelectedWorking)
    {
        ...
        string root = ConfigPaths.EditIsolationDir(scriptId, userKey);
        if (File.Exists(root))
        {
        ...
        foreach (ConfigSessionIsolationPath entry in mark.EditIsolationPaths)
        {
            ...
            string storage = ConfigPaths.EditIsolationEntryDir(scriptId, userKey, entry.Path);
        ...
        string selectedStorage = ConfigPaths.EditIsolationEntryDir(scriptId, userKey, selected.Path);
    ...
    public static void Restore(string scriptId, string userKey, ConfigSessionMark mark)
    {
        ...
        HashSet<string> expectedStorage = mark.EditIsolationPaths
            ...
            .Select(entry => Path.GetFullPath(ConfigPaths.EditIsolationEntryDir(scriptId, userKey, entry.Path)))
