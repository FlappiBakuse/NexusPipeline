...
internal static class ExtraConfigSync
{
    ...
    {
        string root = ConfigPaths.OriginalExtraRoot(scriptId, userKey);
    ...
    private static void Prepare(string scriptId, string userKey, ConfigSessionExtraPath entry)
    {
        ...
        string storeExtra = ConfigPaths.StoreExtraDir(scriptId, userKey, sitePath);
        string originalExtra = ConfigPaths.OriginalExtraDir(scriptId, userKey, sitePath);
