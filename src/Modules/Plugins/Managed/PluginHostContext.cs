...
{
    private readonly IPluginNotificationSink _dispatcher;

    public PluginNotificationAdapter(IPluginNotificationSink dispatcher)
    {
    ...
    {
        return _dispatcher.SendAsync(notification, cancellationToken);
    }
}
