    ...
    string PendingVersion)
{
        ...
        IReadOnlyList<PluginPendingOperation> pending)
    {
        ...
        return new PluginManagementView(
            ...
            manager.HasCapability(summary.Name, PluginCapabilityKeys.Emulator),
            configuredEnabled,
            runtimeEnabled,
            ...
            operation?.Version ?? "")
        {
            ...
            SelfManagedPcLaunch = manager.HasCapability(summary.Name, PluginCapabilityKeys.SelfManagedPcLaunch),
            NoFreshConfig = manager.HasCapability(summary.Name, PluginCapabilityKeys.NoFreshConfig),
