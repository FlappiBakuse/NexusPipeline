...
public sealed class UserIdRecoveryTests
{
    ...
    public void ConfigRunSession_UsesUserIdDirectory_AndKeepsDisplayNamePathSeparate()
    {
        ...
        string canonicalStore = ConfigPaths.StoreDir(scriptId, userId);
        string displayNameStore = ConfigPaths.StoreDir(scriptId, userName);
    ...
    public void Recovery_IgnoresUnboundUserIdResidue()
    {
        ...
        string cache = ConfigPaths.CacheDir(scriptId, unboundUserId);
