...
public sealed class HistoryServiceTests
{
    ...
    public void CountSuccessfulRunsByUserCountsOnlySameDayStatusSuccess()
    {
        ...
        IReadOnlyDictionary<string, int> result = RunHistoryService.CountSuccessfulRunsByUser(
            records,
            date,
            "script-1");
    ...
    public void SummarizeUsersGroupsByStableId()
    {
        ...
        List<HistoryUserSummary> result = RunHistoryService.SummarizeUsers(records, date, "script-1");
    ...
    public void SaveStoresNestedRunDirectoryLogsAndEightScreenshotsPerAttempt()
    {
        ...
        try
        {
            ...
            var service = new RunHistoryService(
                historyRoot,
    ...
    public void SummaryCalculatesStatusDurationAndDailyTrendWithoutPersistingDuration()
    {
        ...
        HistorySummary summary = RunHistoryService.SummarizeRecords(
            records,
            firstDay,
        ...
        Assert.Null(RunHistoryService.DurationMilliseconds(records[3]));
        Assert.Equal(0, RunHistoryService.DurationMilliseconds(records[2]));
    ...
    public void SummarizeUsersCanFilterByStatus()
    {
        ...
        List<HistoryUserSummary> result = RunHistoryService.SummarizeUsers(records, date, status: "success");
        ...
        Assert.True(RunHistoryService.IsValidStatus(" PARTIAL "));
        Assert.False(RunHistoryService.IsValidStatus("unknown"));
    }
    ...
    public void HistoryViewProjectsRecordAndAttemptDurationsWithoutMutatingModel()
    {
        ...
        JsonObject view = RunHistoryService.ToView(record);
