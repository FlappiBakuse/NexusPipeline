...
> 本文档为 v0.6.8～v0.7.6 阶段的历史评估记录，仅用于追溯设计演进，不定义当前产品行为。当前行为以代码、自动测试、[docs/DESIGN.md](../DESIGN.md)、[docs/ARCHITECTURE.md](../ARCHITECTURE.md) 和 [docs/KNOWN-ISSUES.md](../KNOWN-ISSUES.md) 为准。
...
## 4. 后续开发方向（与 ROADMAP 对应，当前基线 v0.7.8）

| 版本 | 主题 | 难度 | 建议 |
|---|---|---|---|
| v0.7.8 | 服务复用、运行生命周期收敛、完整重试配置交换、自动更新配置事务化与队列全局串行 | ⭐⭐⭐⭐ | 已完成，发布门禁全绿 |
...
> 已交付版本（v0.6.8~v0.7.7）与 v0.7.8 开发内容见 [CHANGELOG.md](../../CHANGELOG.md) 与 [ROADMAP.md](../ROADMAP.md)。
