...
**更新日期**：2026-09-14｜**发布模式**：`major=0` 或带 `-beta.N` / `-rc.N` 后缀的版本为 Pre-release；`major>=1` 且无后缀的版本为正式 Release；v1.0.0 起仅 PR 合入
...
模拟器 capability 与判断脚本宿主接口扩展已分别进入开发方向库的专项工作，完成情况按对应版本记录在 CHANGELOG。
