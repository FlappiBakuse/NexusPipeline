...
**建立日期**：2026-08-15（v0.6.9 全面代码评估产出）｜ **维护记录**：v0.6.10~v0.8.1 分批修复台账内全部可修复项（KN-01~83 等，修复详情见 [CHANGELOG.md](../CHANGELOG.md) 对应版本）｜ **v0.8.0 / v0.8.1 复核完成**：两版均未新增已确认问题；本台账仅登记当前未修复问题，已修复条目**彻底移除**，后续新发现按版本登记。
