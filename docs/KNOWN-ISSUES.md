...
**建立日期**：2026-08-15（v0.6.9 全面代码评估产出）｜ **维护记录**：v0.6.10~v0.7.6 分批修复台账内全部可修复项（KN-01~77 等，修复详情见 [CHANGELOG.md](../CHANGELOG.md) 对应版本）｜ **2026-08-16（v0.7.6 评估后）**：已修复条目**彻底移除**，本台账仅登记**当前未修复**问题；后续新发现按版本登记。
