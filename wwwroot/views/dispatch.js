...
function explainPlanMarkup(result) {
  ...
  return `<div class="execution-plan" data-testid="execution-explain-result" role="table" aria-label="${esc(t("dispatch.run_plan_check"))}">
    <div class="execution-plan-summary">
      ...
      <div class="execution-plan-summary-meta">
        <div class="execution-plan-stat"><span class="k">${esc(t("common.task"))}</span><strong class="execution-plan-stat-value">${esc(t("common.unit.tasks", { count: totalTasks }))}</strong><span class="muted execution-plan-stat-subvalue">${esc(queueClass)}</span></div>
