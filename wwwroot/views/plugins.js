...
export async function pagePluginConfig(name, token) {
  ...
  render(`<div class="page-head"><div><a class="back-link" href="#/plugins">← 返回插件</a><div class="eyebrow">PLUGIN CONFIGURATION</div><h2>${esc(plugin?.displayName || name)} · 配置</h2><p class="page-kicker">Webhook 和 SMTP 的密钥会在服务端加密保存。</p></div></div>${body}`);
}
