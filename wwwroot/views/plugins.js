...
export async function pagePluginConfig(name, token) {
  ...
  render(`<div class="page-head"><div><a class="back-link" href="#/plugins">${icon("arrowLeft")} 返回插件</a><div class="eyebrow">插件配置</div><h2>${esc(plugin?.displayName || name)} · 配置</h2><p class="page-kicker">Webhook 和 SMTP 的密钥会在服务端加密保存。</p></div></div>${renderedBody}`);
}
