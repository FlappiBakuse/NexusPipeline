...
export const CI_DOMAINS = [
  ...
  },
  {
    ...
    paths: [
      ...
      "src/Services/EmulatorVendors.cs",
      "tests/e2e/tests/fixtures/adb-stub.cmd",
      "tests/e2e/tests/fixtures/mumu-manager-stub.cmd",
      "tests/e2e/tests/fixtures/ldconsole-stub.cmd",
      "tests/e2e/tests/fixtures/noxconsole-stub.cmd",
      "tests/e2e/tests/fixtures/nox-instance.vbox",
      "tests/e2e/tests/fixtures/bluestacks-player-stub.cmd",
      "tests/e2e/tests/fixtures/bluestacks.conf",
